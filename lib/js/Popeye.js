  ...
  _createClass(Popeye, [{
    ...
    value: function getAnchorPoint() {
      ...
      if (typeof document != "undefined") {
        var _ret = (function () {
          var anchor = _this.props.anchor || _reactDom2["default"].findDOMNode(_this).parentNode;
          var pos = anchor.getBoundingClientRect();
          var anchorOffset = _lodash2["default"].isFunction(_this.props.anchorOffset) ? _this.props.anchorOffset(anchor, _reactDom2["default"].findDOMNode(_this)) : _this.props.anchorOffset;
    ...
    value: function renderLayer() {
      ...
      var child = _react2["default"].cloneElement(childElement, _lodash2["default"].assign(_lodash2["default"].clone(childElement.props), { style: mergedStyles }));
    ...
    value: function render() {
      return _react2["default"].createElement("div", { className: "Popeye" });
    }
  }], [{
    key: "toggleHandler",
...
Popeye.propTypes = {
  ...
  anchor: _react2["default"].PropTypes.object, // domNode
  anchorOffset: _react2["default"].PropTypes.oneOfType([_react2["default"].PropTypes.object, _react2["default"].PropTypes.func]),
  popOffset: _react2["default"].PropTypes.oneOfType([_react2["default"].PropTypes.object, _react2["default"].PropTypes.func]),
